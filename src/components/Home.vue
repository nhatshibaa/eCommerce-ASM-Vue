  ...
  <main class="main">
                ...
                <div class="product-cart-wrap mb-30">
                  <div class="product-img-action-wrap">
                    ...
                    <div class="product-action-1">
                      ...
                      <a aria-label="Compare" class="action-btn hover-up" href="/compare"><i class="fi-rs-shuffle"></i></a>
                    </div>
              ...
              <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                <div class="product-cart-wrap mb-30">
                  ...
                  <div class="product-content-wrap">
                    ...
                    <h2><a href="/shop">Plain Color Pocket Shirts</a></h2>
                    <div class="rating-result" title="90%">
                                            <span>
                                                <span>50%</span>
                                            </span>
            ...
            <div class="product-cart-wrap small hover-up">
              <div class="product-img-action-wrap">
                ...
                <div class="product-action-1">
                  ...
                  <a aria-label="Compare" class="action-btn small hover-up" href="/compare" tabindex="0"><i class="fi-rs-shuffle"></i></a>
                </div>
                <div class="product-badges product-badges-position product-badges-mrg">
                  <span class="hot">Hot</span>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 deal-co">
            <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url('./public/assets/imgs/banner/menu-banner-7.jpg');">
              <div class="deal-top">
                <h2 class="text-brand">Deal of the Day.</h2>
                <h5>Limited quantities.</h5>
              </div>
              <div class="deal-content">
                <h6 class="product-title"><a href="/shop">Summer Collection New Morden Design</a></h6>
          ...
          <div class="col-lg-6 deal-co">
            <div class="deal wow fadeIn animated" style="background-image: url('./public/assets/imgs/banner/menu-banner-8.jpg');">
              <div class="deal-top">
                <h2 class="text-success">Men Clothing</h2>
                <h5>Shirt & Bag</h5>
              </div>
              <div class="deal-content">
                <h6 class="product-title"><a href="/shop">Try something new on vacation</a></h6>
          ...
          <div class="col-lg-3 d-none d-lg-flex">
            <div class="banner-img style-2 wow fadeIn animated">
              ...
              <div class="banner-text">
                ...
                <a href="/shop" class="text-white">Shop Now <i class="fi-rs-arrow-right"></i></a>
              </div>
            </div>
          </div>
                    ...
                    <div class="product-cart-wrap">
                      <div class="product-img-action-wrap">
                        ...
                        <div class="product-action-1">
                          ...
                          <a aria-label="Compare" class="action-btn small hover-up" href="/compare"><i class="fi-rs-shuffle"></i></a>
                        </div>
                        <div class="product-badges product-badges-position product-badges-mrg">
                          <span class="hot">Hot</span>
                        </div>
    ...
    <section class="mb-50">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="banner-bg wow fadeIn animated" style="background-image: url('./public/assets/imgs/banner/banner-8.jpg')">
...
export default {
  ...
  mounted() {
    this.loadJsFile("assets/js/vendor/modernizr-3.6.0.min.js");
    this.loadJsFile("assets/js/vendor/jquery-3.6.0.min.js");
    this.loadJsFile("assets/js/vendor/jquery-migrate-3.3.0.min.js");
    this.loadJsFile("assets/js/vendor/bootstrap.bundle.min.js");
    this.loadJsFile("assets/js/plugins/slick.js");
    this.loadJsFile("assets/js/plugins/jquery.syotimer.min.js");
    this.loadJsFile("assets/js/plugins/wow.js");
    this.loadJsFile("assets/js/plugins/jquery-ui.js");
    this.loadJsFile("assets/js/plugins/perfect-scrollbar.js");
    this.loadJsFile("assets/js/plugins/magnific-popup.js");
    this.loadJsFile("assets/js/plugins/select2.min.js");
    this.loadJsFile("assets/js/plugins/waypoints.js");
    this.loadJsFile("assets/js/plugins/counterup.js");
    this.loadJsFile("assets/js/plugins/jquery.countdown.min.js");
    this.loadJsFile("assets/js/plugins/images-loaded.js");
    this.loadJsFile("assets/js/plugins/isotope.js");
    this.loadJsFile("assets/js/plugins/scrollup.js");
    this.loadJsFile("assets/js/plugins/jquery.vticker-min.js");
    this.loadJsFile("assets/js/plugins/jquery.theia.sticky.js");
    this.loadJsFile("assets/js/plugins/jquery.elevatezoom.js");
    this.loadJsFile("assets/js/shop.js");
